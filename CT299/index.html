        ...
        <header id="top" class="header">
            <div class="headline">
                <div class="left-headline"  >
                    ...
                    <h2 class="logo">Group<span style="color:#E99C2E;">Three</span></h2>
                </div>
                <div class="center-headline">
                    <nav class="menu">
                        <li class="menu-items active"><a href="#top">Home</a></li>
                        <li class="menu-items"><a href="#new-arrival">New Arrival</a></li>
                        <li class="menu-items"><a href="#feature">Features</a></li>
...
<script src="./assets/javascript/to-detail-product.js"></script>
</html>